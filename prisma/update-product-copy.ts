...
const DESCRIPTIONS: Record<string, string> = {
  ...
  "tb-500":
    "Synthetic thymosin beta-4 fragment supplied as lyophilized trifluoroacetate salt. Certified ≥99% purity by HPLC-MS. Suitable for chromatography method development, mass spectrometry calibration, and in-vitro analytical characterization. Requires analytical balance (0.0001g precision) and appropriate laboratory solvents. Enhanced verification may apply. For Research Use Only.",
  retatrutide:
